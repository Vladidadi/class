...
void produce_everything_sequentially( int thread_count)
{
...
//     form_list(argc,argv);
// }
int form_list(int argc, char* argv[])
{
    int i, num_threads;
    ...
    produce_everything_sequentially(num_threads);
